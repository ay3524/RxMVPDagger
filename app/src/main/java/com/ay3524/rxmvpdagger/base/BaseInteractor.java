...
public class BaseInteractor implements MvpInteractor {
    ...
    private final SharedPrefsHelper mPreferencesHelper;
    private final ApiEndpoints mApiHelper;

    @Inject
    public BaseInteractor(ApiEndpoints apiHelper,
                          SharedPrefsHelper sharedPrefsHelper) {
        mPreferencesHelper = sharedPrefsHelper;
        mApiHelper = apiHelper;
    }

    @Override
    public ApiEndpoints getApiHelper() {
        return mApiHelper;
    }

    @Override
    public SharedPrefsHelper getPreferencesHelper() {
